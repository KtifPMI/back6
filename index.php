Спасибо, результаты сохранены.<html lang="ru">
<head>
    <meta charset="UTF-8">
...
<form action="" method="POST">
    <label>
      Имя:<br />
      <input name="fio"   value="DFG"  />
    </label><br />
    <label>
      Email:<br />
      <input name="email"  
        value="leha.grigorev.02@list.ru"
        type="email" />
    </label><br />
    <label>
      Год рождения:<br />
    ...
    Пол:<br />
    <label><input type="radio" checked      name="sex" value="М" />
      М</label>
    <label><input type="radio"  
      name="sex" value="Ж" />
      Ж</label><br />
    Количество конечностей:<br />
<label><input type="radio" name="limb"value="1"/>1</label><label><input type="radio" name="limb"value="2"/>2</label><label><input type="radio" name="limb"value="3"/>3</label><label><input type="radio" name="limb"checked="checked" value="4"/>4</label><br />
    <label>
        Способности:
        <br />
        <select name="power[]"
